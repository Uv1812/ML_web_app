...
dia_mod=pickle.load(open("D:/ML/web file/model/trained_model.sav",'rb'))
ht_mod=pickle.load(open("D:/ML/web file/model/heart_model.sav",'rb'))
par_mod=pickle.load(open("D:/ML/web file/model/parkinson_pre.sav",'rb'))
